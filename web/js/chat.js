...
async function get_chats(){
    ...
    for(var chat_name in dict_chats){
        ...
        // PRIVATE CHAT
            ...
            {
                div_section.innerHTML += '<div class="chat_list' + active_chat_class + '"><div class="chat_people"><div class="chat_img"><img src="img/default_profile_icon.png" alt="profile"></div><div class="chat_ib"><div onclick="get_chat_messages(\'' + chat_name + '\', \'' + shown_chat_name + '\');"><b>' + shown_chat_name + '</b><div id="disconnected_icon"</div></div></div></div></div></div>';
            }
        } // PRIVATE CHAT
